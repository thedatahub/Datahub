...
{
    const ENTITY_NAME = 'VKCDataHubOAuthBundle:Client';
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirectToRoute('vkc_datahub_oauth_clients_show', ['id' => $entity->getId()]);
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirectToRoute('vkc_datahub_oauth_clients_index');
    }
}
