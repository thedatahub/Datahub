...
namespace VKC\DataHub\ResourceBundle\DependencyInjection\Compiler;
...
{
    const DATA_CONVERTER_TAG = 'vkc.datahub.resource.data.converter';
    const DATA_CONVERTER_CONTAINER = 'vkc.datahub.resource.data_converters';
