...
class ProfileControllerTest extends WebTestCase {
    ...
    public function testManageUserAsAdministrator()
    {
        ...
        $value = $crawler->filter('table tr.field-username td')->first()->text();
        $this->assertSame('user', $value);
        $value = $crawler->filter('table tr.field-fullname td')->first()->text();
        $this->assertSame('foo bar', $value);
        $value = $crawler->filter('table tr.field-enabled td')->first()->text();
        $this->assertSame('No', trim($value));
        $value = $crawler->filter('table tr.field-email td')->first()->text();
        $this->assertSame('user@foo.barfoo', $value);
        $value = $crawler->filter('table tr.field-roles td')->first()->text();
